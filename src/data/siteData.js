...
const siteData = {
  business: {
    ...
    legalName: "Merchant Couriers",
    tagline: "Delivering Excellence Across Zimbabwe",
    description: "Founded with a belief that Zimbabwe deserves world-class logistics, Merchant Couriers has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
    phone: "+263 77 949 5409",
    phoneRaw: "+263779495409",
    whatsappNumber: "263779495409",
    email: "info@merchantcouriers.co.zw",
    ...
    cookieConsentKey: "merchant-couriers-cookie-consent",
    socialLinks: { facebook: "https://www.facebook.com/techzim/posts/delivery-services-are-not-the-sexiest-lines-of-business-but-they-can-be-very-con/10156468705999431/", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Merchant", logoLine2: "Couriers" },
  ...
  homeTestimonials: [
    { text: "We switched to Merchant Couriers six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Same-day delivery in Harare that actually works. Merchant Couriers has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
    { text: "Reliable, professional, and always on time. Merchant Couriers handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Founded with a belief that Zimbabwe deserves world-class logistics, Merchant Couriers has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
  ...
  reviews: {
    ...
    items: [
      { text: "We switched to Merchant Couriers six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5 },
      { text: "Same-day delivery in Harare that actually works. Merchant Couriers has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5 },
      { text: "Reliable, professional, and always on time. Merchant Couriers handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Merchant Couriers exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Merchant Couriers to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Merchant Couriers is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Merchant Couriers has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Merchant Couriers! I would like to request a quote.",
